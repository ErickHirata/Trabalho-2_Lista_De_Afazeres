      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          leading: Container(
            ...
            child: Image.network('https://estude-unicv.com/img/logo-share.jpg'), // Usando Image.network para carregar uma imagem da internet
          ),
        ),
        backgroundColor: Color.fromARGB(255, 110, 155, 110), // Definindo a cor de fundo como verde
